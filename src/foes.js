...
export const FOES = {
  stalker: { name: '듄 스토커', hp: 5, radius: 2.4, interval: 2, warning: .7, speed: 48 },
  brute: { name: '오거', hp: 8, radius: 3.1, interval: 2.3, warning: .8, speed: 54 },
  hexer: { name: '헥스 스피릿', hp: 5, radius: 2.4, interval: 2, warning: .7, speed: 48 },
  bandit: { name: '산적', hp: 2.5, radius: 1.6, interval: 2.4, warning: .65, speed: 78, arrow: true },
  guard: { name: '탑 수호자', hp: 4, radius: 1.7, interval: 1.9, warning: .75, speed: 88, arrow: true },
  dragon: { name: '엠버 드레이크', hp: 12, radius: 4, interval: 1.5, warning: .65, speed: 64, mobile: true },
  wizard: { name: '떠돌이 카펫 마법사', hp: 7, radius: 2.6, interval: 1.35, warning: .6, speed: 68, mobile: true },
  fish: { name: '리버 펭', hp: 2, radius: 1.8, interval: Infinity, warning: 0, speed: 0 },
  giant: { name: '칸다하르 거인', hp: 18, radius: 6, interval: 2, warning: 1, speed: 65 },
};
