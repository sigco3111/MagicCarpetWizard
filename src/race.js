...
export const RACE_LEVELS = {
  easy: { name: '이지', length: 896, spacing: 224, radius: 40, gateBase: 14, density: .22, height: 12, spread: 20, zone: 1, description: '열린 정원 · 크고 너그러운 게이트 · 적은 장애물' },
  medium: { name: '보통', length: 1280, spacing: 256, radius: 10, density: .5, height: 23, spread: 32, zone: 0, description: '지붕 슬라롬 · 날카로운 회전 · 높은 장애물' },
  hard: { name: '어려움', length: 1536, spacing: 192, radius: 8, density: .82, height: 35, spread: 39, zone: 3, description: '협곡 질주 · 좁은 게이트 · 빽빽한 암석' },
};
