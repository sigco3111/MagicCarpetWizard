...
export const BOSS_TYPES = [
  { kind: 'dragon', name: '아즈라크 · 잿불 드래곤', hp: 30, speed: 57, interval: 1.5, radius: 7, scale: 2.3 },
  { kind: 'wizard', name: '사히르 · 추방된 비지르', hp: 24, speed: 61, interval: 1.25, radius: 5, scale: 2.6 },
  { kind: 'scarab', name: '크헤프리 · 강철의 군세', hp: 32, speed: 51, interval: 1.65, radius: 7, scale: 3.2, wards: 2 },
  { kind: 'serpent', name: '나디라 · 모래 뱀', hp: 28, speed: 55, interval: 1.4, radius: 6, scale: 3 },
];
